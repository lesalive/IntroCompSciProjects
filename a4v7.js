...
function splat(o){
    ...
    ctx.arc(o.x+o.size, o.y+o.size, 0.7*o.sizesmall, 0, 2*pi); //small splat
    ctx.arc(o.x+2*o.size, o.y+2*o.size, 0.3*o.sizesmall, 0, 2*pi); //tiny splat
    ctx.fill();
...
function createSplatData(array, obj){
    array.push({
        ...
        size: obj.size,
        color: obj.color,
        sizesmall: obj.change.size*obj.size*4
    })
}
